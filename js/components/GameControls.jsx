...
export default class GameControls extends React.Component{
	...
	gameControlsHighlight(e){
		if((e.target.id === 'startButton') || (e.target.id === 'stopButton')){
			...
			if(e.target.id === 'stopButton'){
				document.getElementById("nextgenButton").disabled = "";
			}
		}
	...
	render(){		
		return(
			<div>
				<div className="text-center" id="gameControls" onClick={this.gameControlsHighlight}>
				...
				<div className="text-center" id="speedControls" onClick={this.speedControlsHighlight}>
